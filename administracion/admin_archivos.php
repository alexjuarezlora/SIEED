    ...
    <ul class="nospace group">
          ...
          <li class="btmspace-50">
            <article class="service largeicon"><i class="icon nobg circle fa fa-file-pdf-o"></i>
              ...
              <p>Edite el archivo compartido seleccionado</p><br>

              <div id="comments"> 
              <form method="POST" action="#">
              <label for="aviso_banner"><strong>Descripción del aviso</strong></label>
              <input name="aviso_banner" type="text" placeholder="Listado Curricular de la zona" value="Listado Curricular de la zona">
              <div class="one_half first">
              <label for="link_archivo"><strong>Cargar un archivo</strong></label>
              <input type="file" name="link_archivo" accept=".pdf">
                
              </div>
              <div class="one_half">
                <label><strong>&nbsp;&nbsp;&nbsp;&nbsp;Archivo actualmente cargado</strong></label>
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="#">Lineamientos.pdf</a>
              <br><br>
              </div>
              ...
              <button onclick="location.href = 'administracion_sistema.php';">Volver</button>
              </div>
           </article>
          </li>
        </ul>
