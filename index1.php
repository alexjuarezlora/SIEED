...
<head>
    ...
    <link href="layout/styles/modal.css" rel="stylesheet">
   
    <script type="text/javascript">
        function olvidopass() {
            alert("Es necesario que te comuniques con el coordinador general de Deportes, el podrá restablecer tu Contraseña");
        }
        ;
    </script>
</head>
...
<div id="modal">
        <div class="modal-content">
            ...
            <div class="copy">
                <p>Bienvenido al Nuevo sistema SIEED. Es necesario que actualices los datos de tu <a href="tecnologicos/perfil.php">perfil</a>. <br> 
                En el caso de los tecnológicos, es tambien necesario actualizar la información de las <a href="tecnologicos/autoridades.php">Autoridades del plantel</a> <br>
                Si ya haz realizado los cambios, ignora este mensaje</p>

                </div>
            <div class="cf footer">
                <a href="#" class="btn_aviso">Entendido</a>
            ...
            <div class="txtoverlay">
                <div class="centralise">
                    <div class="verticalwrap">
                        <article>
                            <h2 class="heading ">Nuevo Sistema. Favor de actualizar los datos</h2>

                            <p><a class="btn orange pushright" href="#modal">Ver</a></p>
                        </article>
                    </div>
                </div>
            </div>
    ...
    <main class="container clear">
        ...
        <div class='one_quarter'>
            ...
            if (!empty($_SESSION["nombre"])) {
                ...
                <a href='#' onclick='olvidopass()'>¿Olvidaste tu contraseña?</a>
